...
echo "  - Othello: http://localhost:$PORT/othello-game/"
echo "  - Solitaire: http://localhost:$PORT/solitaire-game/"
echo "  - Minesweeper: http://localhost:$PORT/minesweeper-game/"
echo "  - Space Invaders: http://localhost:$PORT/space-invaders-game/"
echo "  - Math Facts: http://localhost:$PORT/math-facts-game/"
echo "  - Reading Speed: http://localhost:$PORT/reading-speed-game/
  - Typing Master: http://localhost:$PORT/typing-game/"
echo ""
